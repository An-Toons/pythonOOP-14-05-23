class Student:
    ...
    def evaluation_lecturer(self, lecturer, course, grade):
        """
        Функция выставляет оценки лекторам, от студентов, по какому курсу
        """
...
class Reviewer(Mentor):
    ...
    def evaluation_student(self, student, course, grade):
        """
        Выставляет оценки от лекторов студентам
        """
...
another_some_student = Student('Nikolas', 'Cage', 'your_gender')
...
another_some_reviewer = Reviewer('Mary', 'Jane')
...
another_some_lecturer = Lecturer('Mary', 'Jane')
...
another_some_reviewer.evaluation_student(another_some_student, 'JavaScript', 7)
another_some_reviewer.evaluation_student(another_some_student, 'JavaScript', 8)

some_student.evaluation_lecturer(some_lecturer, 'Python', 10)
some_student.evaluation_lecturer(some_lecturer, 'Python', 9)
some_student.evaluation_lecturer(another_some_lecturer, 'Python', 9)
some_student.evaluation_lecturer(another_some_lecturer, 'Python', 9)
some_student.evaluation_lecturer(some_lecturer, 'Git', 10)
some_student.evaluation_lecturer(some_lecturer, 'Git', 10)
another_some_student.evaluation_lecturer(another_some_lecturer, 'JavaScript', 8)
another_some_student.evaluation_lecturer(another_some_lecturer, 'JavaScript', 9)
another_some_student.evaluation_lecturer(some_lecturer, 'Git', 10)
